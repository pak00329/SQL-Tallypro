DECLARE @WHERE AS VARCHAR(50) = 'Northmead'
...
SELECT Total.Date, Total.Total, 
	...
	(
	SELECT 
	substring(CONVERT(VARCHAR,No_Dups.DateTime,120), 1, 7) as Date,
	...
	Logger.SiteId IN (1,2,3,4,5,6,7)
	GROUP BY substring(CONVERT(VARCHAR,No_Dups.DateTime,120), 1, 7)
	) AS Total
	LEFT OUTER JOIN 
	(
	SELECT 
